...
async function initFirebase(){
  ...
  try{
    ...
    setBackendStatus('LCS v0.7.6 auth + popup + discussion sync connected','Public content uses random public profile IDs. Status authorization, soft-delete retention, and immutable moderation logs are enforced by Firestore rules.','ok');
