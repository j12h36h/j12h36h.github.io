window.DAI_CREATOR_CATALOG = {
  "actions": [
    ...
    },
    {
      ...
      "category": "Game Customization (DAI 1.9.9)",
      "params": [
        "direction",
        "action",
        "open",
      ...
      "purpose": "Dispatch an event to a DAI 1.9.9 customization definition. direction=kind, action=definition id, open=event name, target=runtime payload/position, value=numeric payload."
    },
    {
      ...
      "purpose": "Activate a DAI 1.9.9 customization definition and dispatch activate (or the event named in open)."
    },
    {
      ...
      "purpose": "Deactivate a DAI 1.9.9 customization definition and dispatch deactivate (or the event named in open)."
    },
    {
      "id": "sound_play",
      "category": "Game Customization (DAI 1.9.9)",
    ...
    },
    {
      ...
      "category": "Runtime State & Capabilities (DAI 1.9.9)",
      "params": [
        "action",
        "state"
      ],
    ...
    },
    {
      ...
      "category": "Runtime References (DAI 1.9.9)",
      "params": [
        "action"
      ],
    ...
    },
    {
      ...
      "category": "Native Attributes (DAI 1.9.9)",
      "params": [
        "action",
        "target",
        "value"
    ...
    {
      "id": "animation_play",
      "category": "Animation Runtime (DAI 1.9.9)",
      "params": [
        "action",
        "target"
      ],
    ...
    {
      "id": "content_activate",
      "category": "Custom Content Runtime (DAI 1.9.9)",
      "params": [
        "action",
        "target",
        "ticks",
    ...
    },
    {
      ...
      "category": "Entity Status (DAI 1.9.9)",
      "params": [
        "target",
        "value"
      ],
    ...
    },
    {
      ...
      "category": "Server Authority (DAI 1.9.9)",
      "params": [
        "action",
        "target",
        "state",
