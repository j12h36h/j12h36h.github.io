window.DAI_CREATOR_CATALOG = {
  "actions": [
    ...
    },
    {
      ...
      "category": "Game Customization (DAI 1.9.2)",
      "params": [
        "direction",
        "action",
        "open",
      ...
      "purpose": "Dispatch an event to a DAI 1.9.2 customization definition. direction=kind, action=definition id, open=event name, target=runtime payload/position, value=numeric payload."
    },
    {
      ...
      "purpose": "Activate a DAI 1.9.2 customization definition and dispatch activate (or the event named in open)."
    },
    {
      ...
      "purpose": "Deactivate a DAI 1.9.2 customization definition and dispatch deactivate (or the event named in open)."
    },
    {
      "id": "sound_play",
      "category": "Game Customization (DAI 1.9.2)",
