...
const RUNTIME_DEFINITION_TYPES={
  ...
  sound:{label:"DAI 2.2 Sound",folder:"dai_sounds",customization:true,carrierResourceId:true,sample:{display_name:"UI Chime",carrier:"minecraft:block.note_block.pling",properties:{source:"master"},numbers:{volume:1.0,pitch:1.0},events:{}}},
  music:{label:"DAI 2.2 Music",folder:"dai_music",customization:true,carrierResourceId:true,sample:{display_name:"Experience Music",carrier:"minecraft:music.game",numbers:{volume:1.0,pitch:1.0},events:{}}},
  hud:{label:"DAI 2.2 HUD",folder:"dai_hud",customization:true,sample:{display_name:"Status HUD",texture:"my_dai_pack:gui/status",numbers:{x:0,y:0,width:128,height:32,z:20,ticks:0,alpha:1.0},properties:{anchor:"top_left",color:"#FFFFFF",click_action:""},flags:{interactable:false,consume_click:false,hide_vanilla:false},events:{}}},
  render_profile:{label:"DAI 2.2 Render Profile",folder:"dai_render_profiles",customization:true,sample:{display_name:"Cinematic Profile",properties:{},numbers:{},flags:{},events:{apply:"action:my_dai_pack:apply_render_profile",clear:"action:my_dai_pack:clear_render_profile"}}},
  structure:{label:"DAI 2.2 Structure / Natural Structure",folder:"dai_structures",customization:true,carrierResourceId:true,sample:{display_name:"Placed Structure",carrier:"minecraft:village/plains/houses/plains_small_house_1",target:"~ ~ ~",flags:{natural:false},properties:{placement:"surface",dimensions:"minecraft:overworld",rotation:"random",mirror:"none"},numbers:{spacing_chunks:24,separation_chunks:8,frequency:1.0,min_y:-64,max_y:320},events:{}}},
  feature:{label:"DAI 2.2 World Feature / Natural Feature",folder:"dai_features",customization:true,carrierResourceId:true,sample:{display_name:"Placed Feature",carrier:"minecraft:ore_coal",target:"~ ~ ~",flags:{natural:false},properties:{placement:"surface",dimensions:"minecraft:overworld"},numbers:{spacing_chunks:6,separation_chunks:2,frequency:1.0},events:{}}},
  loot:{label:"DAI 2.2 Loot",folder:"dai_loot",customization:true,carrierResourceId:true,sample:{display_name:"Reward Loot",carrier:"minecraft:chests/simple_dungeon",events:{}}},
  currency:{label:"DAI 2.2 Currency",folder:"dai_currencies",customization:true,sample:{display_name:"Credits",properties:{objective:"credits"},numbers:{amount:1.0},events:{}}},
  shop:{label:"DAI 2.2 Shop",folder:"dai_shops",customization:true,sample:{display_name:"Field Shop",entries:["my_dai_pack:starter_item"],events:{open:"action:my_dai_pack:shop_open",purchase:"action:my_dai_pack:shop_purchase"}}},
  dialogue:{label:"DAI 2.2 Dialogue",folder:"dai_dialogues",customization:true,sample:{display_name:"NPC Introduction",entries:["Welcome, agent."],events:{start:"action:my_dai_pack:dialogue_start",choose:"action:my_dai_pack:dialogue_choose",end:"action:my_dai_pack:dialogue_end"}}},
  quest:{label:"DAI 2.2 Quest",folder:"dai_quests",customization:true,sample:{display_name:"First Assignment",entries:["Reach the objective."],events:{start:"action:my_dai_pack:quest_start",advance:"action:my_dai_pack:quest_advance",complete:"action:my_dai_pack:quest_complete",fail:"action:my_dai_pack:quest_fail"}}},
  faction:{label:"DAI 2.2 Faction",folder:"dai_factions",customization:true,sample:{display_name:"Border",properties:{tag:"faction_border"},events:{}}},
  biome:{label:"DAI 2.2 Native Biome",folder:"dai_biomes",sample:{has_precipitation:true,temperature:0.8,downfall:0.4,water_color:"#3f76e4",effects:{fog_color:12638463,sky_color:7907327},spawners:{},spawn_costs:{}}},
  dimension_type:{label:"DAI 2.2 Dimension Type",folder:"dai_dimension_types",sample:{natural:true,ultrawarm:false,has_skylight:true,has_ceiling:false,coordinate_scale:1.0,ambient_light:0.0,min_y:-64,height:384,logical_height:384,infiniburn:"#minecraft:infiniburn_overworld",effects:"minecraft:overworld"}},
  timeline:{label:"DAI 2.2 Timeline / World Clock",folder:"dai_timelines",sample:{world_clock:"minecraft:overworld",day_length:24000}},
  dimension:{label:"DAI 2.2 Native Dimension",folder:"dai_dimensions",sample:{generation:{type:"void",dimension_type:"minecraft:overworld",biome:"minecraft:the_void",features:false,lakes:false,structures:false}}},
  native_registry:{label:"DAI 2.2 Open Mojang Registry Bridge",folder:"dai_registry",sample:{registry:"damage_type",raw:{message_id:"my_damage",exhaustion:0.1,scaling:"never"}}},
  native_data:{label:"DAI 2.2 Open Server-Data Bridge",folder:"dai_data",sample:{output:"predicate",raw:{condition:"minecraft:entity_properties",entity:"this",predicate:{}}}},
  ruleset:{label:"DAI 2.2 Ruleset",folder:"dai_rules",customization:true,sample:{display_name:"Adventure Rules",entries:["doDaylightCycle=false","keepInventory=true"],events:{}}},
  vehicle:{label:"DAI 2.2 Vehicle",folder:"dai_vehicles",customization:true,carrierResourceId:true,sample:{display_name:"Light Vehicle",carrier:"minecraft:minecart",numbers:{acceleration:0.045,reverse_acceleration:0.035,max_speed:0.8,reverse_speed:0.32,drag:0.06,braking:0.14,turn_rate:6.0,strafe_factor:0.0,jump_velocity:0.42,boost_multiplier:1.35},flags:{camera_steering:true,allow_reverse:true,allow_jump:false,gravity:true,lock_driver_pitch:false},events:{tick:"",boost:""}}},
  portal:{label:"DAI 2.2 Standalone Portal Volume",folder:"dai_portals",customization:true,sample:{display_name:"Portal Volume",target:"0 64 0",properties:{shape:"box",dimension:"minecraft:overworld",destination:"minecraft:the_nether",destination_target:"0 80 0",affects:"players",required_tag:"",forbidden_tag:""},numbers:{width:3,height:5,depth:1,cooldown_ticks:40,yaw:0,pitch:0},flags:{enabled:true,preserve_velocity:true,preserve_rotation:true},events:{enter:"",exit:""}}},
  interactive:{label:"DAI 2.2 Interactive Volume",folder:"dai_interactives",customization:true,sample:{display_name:"Control Zone",target:"0 64 0",properties:{shape:"box",dimension:"minecraft:overworld",required_tag:"",forbidden_tag:""},numbers:{width:3,height:3,depth:3,tick_interval:1},flags:{enabled:true},events:{enter:"",tick:"",exit:"",use:`action:${state.pack.namespace}:console_use`,attack:""}}},
  fluid:{label:"DAI 2.2 Fluid Behavior",folder:"dai_fluids",customization:true,carrierResourceId:true,sample:{display_name:"Energy Fluid",carrier:"minecraft:water",numbers:{drag:0.2,vertical_drag:0.2,buoyancy:0.02,damage:0,damage_interval:20,tick_interval:1},flags:{extinguish:false,no_gravity:false},events:{enter:"",tick:"",exit:""}}},
  environment:{label:"DAI 2.2 Environment",folder:"dai_environments",customization:true,sample:{display_name:"Training Arena",events:{enter:"action:my_dai_pack:arena_enter",exit:"action:my_dai_pack:arena_exit"}}}
};
...
function updateModeUi(){
  ...
  $("#workspaceDescription").textContent = resource
    ? "Create or import a Minecraft resource pack, add textures and other assets, opt into DAI 2.2 companion auto-enable, coordinate directional combat presentation where applicable, then export a normal editable ZIP."
    : "Create a complete DAI Engine 2.2 game or addon: experiences, native entities, worldgen, objectives, server-authoritative actions, menus, reactions and custom content. Universal Files can create anything the guided editor does not expose; the Musashi directional-combat client hook is documented separately.";
...
const UNIVERSAL_TEMPLATES={
  ...
  native_ai:()=>[`data/${state.pack.namespace}/logics/definitions/native_entity_ai.json`,JSON.stringify({sequence:[{type:"target_player",conditions:[{type:"entity_has_target",operator:"is_false"}]},{type:"look_at_target",conditions:[{type:"entity_has_target",operator:"is_true"}]},{type:"move_to_target",value:1.0,conditions:[{type:"entity_target_distance",operator:"greater_than",number_value:2.2}]},{type:"melee_attack",value:2.2,conditions:[{type:"entity_target_distance",operator:"less_than_or_equal",number_value:2.2},{type:"entity_can_see_target",operator:"is_true"}]},{type:"wander",value:0.8,ticks:5,conditions:[{type:"entity_has_target",operator:"is_false"}]}]},null,2)+"\n"],
...
function validateAction(a,path,issues,objectiveIds){
  ...
  if(!actionMap.has(a.type))issues.push({level:"warn",message:`${path}: unknown/imported action type '${a.type}' is preserved but cannot be fully validated by this DAI 2.2 creator catalog.`});
...
// ---- DAI 2.2 Browser Gameplay Tester ------------------------------------
