...
const RUNTIME_DEFINITION_TYPES={
  keybind:{label:"DAI 3.9 Datapack Keybind",folder:"dai_keybinds",sample:{display_name:"Ability Key",category:"gameplay",default_key:"key.keyboard.g"}},
  data_screen:{label:"DAI 3.9 Data Screen",folder:"dai_screens",sample:{title:"DAI Screen",width:320,height:220,close_on_escape:true,pause_game:false,widgets:[{type:"label",id:"title",x:16,y:14,width:200,height:20,label:"STATUS",color:4294967295},{type:"button",id:"resume",x:16,y:176,width:120,height:20,label:"RESUME",action:"my_dai_pack:resume"}]}},
  ...
  sound:{label:"DAI 3.9 Sound",folder:"dai_sounds",customization:true,carrierResourceId:true,sample:{display_name:"UI Chime",carrier:"minecraft:block.note_block.pling",properties:{source:"master"},numbers:{volume:1.0,pitch:1.0},events:{}}},
  music:{label:"DAI 3.9 Music",folder:"dai_music",customization:true,carrierResourceId:true,sample:{display_name:"Experience Music",carrier:"minecraft:music.game",numbers:{volume:1.0,pitch:1.0},events:{}}},
  hud:{label:"DAI 3.9 HUD",folder:"dai_hud",customization:true,sample:{display_name:"Status HUD",texture:"my_dai_pack:gui/status",numbers:{x:0,y:0,width:128,height:32,z:20,ticks:0,alpha:1.0},properties:{anchor:"top_left",color:"#FFFFFF",click_action:""},flags:{interactable:false,consume_click:false,hide_vanilla:false},events:{}}},
  render_profile:{label:"DAI 3.9 Render Profile",folder:"dai_render_profiles",customization:true,sample:{display_name:"Cinematic Profile",properties:{},numbers:{},flags:{},events:{apply:"action:my_dai_pack:apply_render_profile",clear:"action:my_dai_pack:clear_render_profile"}}},
  ...
  feature:{label:"DAI 3.9 World Feature / Natural Feature",folder:"dai_features",customization:true,carrierResourceId:true,sample:{display_name:"Placed Feature",carrier:"minecraft:ore_coal",target:"~ ~ ~",flags:{natural:false},properties:{placement:"surface",dimensions:"minecraft:overworld"},numbers:{spacing_chunks:6,separation_chunks:2,frequency:1.0},events:{}}},
  loot:{label:"DAI 3.9 Loot",folder:"dai_loot",customization:true,carrierResourceId:true,sample:{display_name:"Reward Loot",carrier:"minecraft:chests/simple_dungeon",events:{}}},
  currency:{label:"DAI 3.9 Currency",folder:"dai_currencies",customization:true,sample:{display_name:"Credits",properties:{objective:"credits"},numbers:{amount:1.0},events:{}}},
  shop:{label:"DAI 3.9 Shop",folder:"dai_shops",customization:true,sample:{display_name:"Field Shop",entries:["my_dai_pack:starter_item"],events:{open:"action:my_dai_pack:shop_open",purchase:"action:my_dai_pack:shop_purchase"}}},
  dialogue:{label:"DAI 3.9 Dialogue",folder:"dai_dialogues",customization:true,sample:{display_name:"NPC Introduction",entries:["Welcome, agent."],events:{start:"action:my_dai_pack:dialogue_start",choose:"action:my_dai_pack:dialogue_choose",end:"action:my_dai_pack:dialogue_end"}}},
  quest:{label:"DAI 3.9 Quest",folder:"dai_quests",customization:true,sample:{display_name:"First Assignment",entries:["Reach the objective."],events:{start:"action:my_dai_pack:quest_start",advance:"action:my_dai_pack:quest_advance",complete:"action:my_dai_pack:quest_complete",fail:"action:my_dai_pack:quest_fail"}}},
  faction:{label:"DAI 3.9 Faction",folder:"dai_factions",customization:true,sample:{display_name:"Border",properties:{tag:"faction_border"},events:{}}},
  biome:{label:"DAI 3.9 Native Biome",folder:"dai_biomes",sample:{has_precipitation:true,temperature:0.8,downfall:0.4,water_color:"#3f76e4",effects:{fog_color:12638463,sky_color:7907327},spawners:{},spawn_costs:{}}},
  dimension_type:{label:"DAI 3.9 Dimension Type",folder:"dai_dimension_types",sample:{natural:true,ultrawarm:false,has_skylight:true,has_ceiling:false,coordinate_scale:1.0,ambient_light:0.0,min_y:-64,height:384,logical_height:384,infiniburn:"#minecraft:infiniburn_overworld",effects:"minecraft:overworld"}},
  timeline:{label:"DAI 3.9 Timeline / World Clock",folder:"dai_timelines",sample:{world_clock:"minecraft:overworld",day_length:24000}},
  dimension:{label:"DAI 3.9 Native Dimension",folder:"dai_dimensions",sample:{generation:{type:"void",dimension_type:"minecraft:overworld",biome:"minecraft:the_void",features:false,lakes:false,structures:false}}},
  native_registry:{label:"DAI 3.9 Open Mojang Registry Bridge",folder:"dai_registry",sample:{registry:"damage_type",raw:{message_id:"my_damage",exhaustion:0.1,scaling:"never"}}},
  native_data:{label:"DAI 3.9 Open Server-Data Bridge",folder:"dai_data",sample:{output:"predicate",raw:{condition:"minecraft:entity_properties",entity:"this",predicate:{}}}},
  ruleset:{label:"DAI 3.9 Ruleset",folder:"dai_rules",customization:true,sample:{display_name:"Adventure Rules",entries:["doDaylightCycle=false","keepInventory=true"],events:{}}},
  vehicle:{label:"DAI 3.9 Vehicle",folder:"dai_vehicles",customization:true,carrierResourceId:true,sample:{display_name:"Light Vehicle",carrier:"minecraft:minecart",numbers:{acceleration:0.045,reverse_acceleration:0.035,max_speed:0.8,reverse_speed:0.32,drag:0.06,braking:0.14,turn_rate:6.0,strafe_factor:0.0,jump_velocity:0.42,boost_multiplier:1.35},flags:{camera_steering:true,allow_reverse:true,allow_jump:false,gravity:true,lock_driver_pitch:false},events:{tick:"",boost:""}}},
  portal:{label:"DAI 3.9 Standalone Portal Volume",folder:"dai_portals",customization:true,sample:{display_name:"Portal Volume",target:"0 64 0",properties:{shape:"box",dimension:"minecraft:overworld",destination:"minecraft:the_nether",destination_target:"0 80 0",affects:"players",required_tag:"",forbidden_tag:""},numbers:{width:3,height:5,depth:1,cooldown_ticks:40,yaw:0,pitch:0},flags:{enabled:true,preserve_velocity:true,preserve_rotation:true},events:{enter:"",exit:""}}},
  interactive:{label:"DAI 3.9 Interactive Volume",folder:"dai_interactives",customization:true,sample:{display_name:"Control Zone",target:"0 64 0",properties:{shape:"box",dimension:"minecraft:overworld",required_tag:"",forbidden_tag:""},numbers:{width:3,height:3,depth:3,tick_interval:1},flags:{enabled:true},events:{enter:"",tick:"",exit:"",use:`action:${state.pack.namespace}:console_use`,attack:""}}},
  fluid:{label:"DAI 3.9 Fluid Behavior",folder:"dai_fluids",customization:true,carrierResourceId:true,sample:{display_name:"Energy Fluid",carrier:"minecraft:water",numbers:{drag:0.2,vertical_drag:0.2,buoyancy:0.02,damage:0,damage_interval:20,tick_interval:1},flags:{extinguish:false,no_gravity:false},events:{enter:"",tick:"",exit:""}}},
  environment:{label:"DAI 3.9 Environment",folder:"dai_environments",customization:true,sample:{display_name:"Training Arena",events:{enter:"action:my_dai_pack:arena_enter",exit:"action:my_dai_pack:arena_exit"}}}
};
...
function updateModeUi(){
  ...
  $("#workspaceDescription").textContent = resource
    ? "Create or import a Minecraft resource pack, add textures and other assets, opt into DAI 3.9 companion auto-enable, coordinate directional combat presentation where applicable, then export a normal editable ZIP."
    : "Create a complete DAI Engine 3.9 game or addon: experiences, native entities, worldgen, objectives, server-authoritative actions, menus, reactions and custom content. Universal Files can create anything the guided editor does not expose; the Musashi directional-combat client hook is documented separately.";
...
function validateAction(a,path,issues,objectiveIds){
  ...
  if(!actionMap.has(a.type))issues.push({level:"warn",message:`${path}: unknown/imported action type '${a.type}' is preserved but cannot be fully validated by this DAI 3.9 creator catalog.`});
...
// ---- DAI 3.9 Browser Gameplay Tester ------------------------------------
